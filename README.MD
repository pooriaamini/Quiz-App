...
![Screenshot of Question Screen](2.png)
![Screenshot of Question Screen after it has been Answered](3.png)
...
3. Start the JSON Server:(Assumes data is stored in db.json):
